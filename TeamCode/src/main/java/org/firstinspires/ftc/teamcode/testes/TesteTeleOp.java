...
@TeleOp(name="Teste", group="BahTech")
...
public class TesteTeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // Largar a amostra na extensora
            if (!gamepad2.square) {
                square = true;
            }
            if (gamepad2.square && square) {
                BC.setTargetPosition(-50);
                BC.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                smoother(BC, 0.3);
                sleep(100);
                PC.setTargetPosition(73);
                ...
                SL.setPosition(0);
                sleep(100);
                PC.setTargetPosition(190);
                PC.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                smoother(PC, 0.3);
                sleep(100);
                BC.setTargetPosition(12);
                BC.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                smoother(BC, 0.3);
                square = false;
            }
